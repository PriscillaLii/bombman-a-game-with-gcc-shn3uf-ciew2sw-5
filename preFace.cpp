...
void preFace::start()
{
    ...
    //&的用法，生成Alt+头字母的快捷方式
    //startButton->setDefault(true);//设置为默认按钮（回车打开）
...
{
    player2 = 1;
    //bombMan.setplayer2(1);
    delete RoleLabel2;gameStart();
}

void preFace::role2_2choosed()
{
    player2 = 2;
    //bombMan.setplayer2(2);
    delete RoleLabel2;
    gameStart();
}
